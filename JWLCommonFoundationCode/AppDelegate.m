...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = [[JWLTabBarController alloc] init];
...
//    if ([JWLUserLoginModel sharedUserLoginModel].isLogin) {
//        NSLog(@"登录");
//    }else{
//        
//        NSLog(@"没有登录");
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"JWLCommonFoundationCode"];
